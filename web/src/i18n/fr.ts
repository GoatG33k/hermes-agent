...
export const fr: Translations = {
  ...
  kanban: {
    ...
    liveRun: "Exécution en direct",
    streaming: "diffusion",
    connecting: "connexion…",
    waitingForOutput: "(en attente de sortie…)",
    steerPlaceholder: "Orienter l'agent en cours… (Entrée pour envoyer)",
    steerSend: "Orienter",
    ...
    addParentSearch: "Rechercher pour ajouter un parent…",
    addChildSearch: "Rechercher pour ajouter un enfant…",
